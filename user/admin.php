...
<head>
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="../template2/plugins/select2/css/select2.min.css">
  <link rel="stylesheet" href="../template2/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
...
<body class="hold-transition sidebar-mini">
  ...
  <!-- Select2 -->
  <script src="../template2/plugins/select2/js/select2.full.min.js"></script>
  <!-- AdminLTE App -->
  ...
  <script>
    $(function() {
      ...
      // ==========================
      // Sinkron nama_pemesan <-> email
      // ==========================
      function syncNamaPemesan() {
        var opt = $('#email option:selected');
        var nama = opt.data('nama') || '';
        $('#nama_pemesan').val(nama);
      }

      // Set nilai awal (saat halaman dibuka)
      if ($('#email').length && $('#nama_pemesan').length) {
        syncNamaPemesan();
        // Update setiap kali email berubah
        $('#email').on('change', syncNamaPemesan);
      }
    });
  </script>
